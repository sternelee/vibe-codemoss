# message-compact-display-math-compatibility Specification

## Purpose
TBD - created by archiving change harden-message-compact-display-math-boundaries. Update Purpose after archive.
## Requirements
