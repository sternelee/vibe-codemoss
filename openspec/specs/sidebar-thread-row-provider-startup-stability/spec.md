# sidebar-thread-row-provider-startup-stability Specification

## Purpose
TBD - created by archiving change fix-sidebar-thread-row-provider-startup-loop. Update Purpose after archive.
## Requirements
