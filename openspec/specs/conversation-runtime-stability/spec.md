...
When runtime-dependent actions fail or end unexpectedly, the system MUST classify the failure into a structured stability diagnostic rather than only exposing raw transport or provider text.
