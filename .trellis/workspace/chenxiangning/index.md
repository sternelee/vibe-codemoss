...
| 1037 | 2026-07-19 | 对齐 agent catalog Rust 代码格式 | `13d05cda` | `feature/v-0.7.4` |
...
| 1029 | 2026-07-18 | 归档性能提案并同步主规范 | `1b3418425e3fb7d4aa40f23332c9b55c2b565924` | `feature/v-0.7.4` |
| 1028 | 2026-07-18 | 校准并归档旧 OpenSpec 提案 | `01edb4bb` | `feature/v-0.7.4` |
...
| 1010 | 2026-07-17 | 完善文件追溯与多仓路径隔离 | `6031d97e` | `feature/v-0.7.4` |
...
| 1002 | 2026-07-16 | 修复 Codex 新建磁盘会话 loading 常驻 | `0efde5a0` | `feature/v-0.7.4` |
...
| 959 | 2026-07-05 | 归档 OpenSpec 近期变更提案 | `f68626ca` | `ui-refactoring` |
...
| 668 | 2026-06-01 | Phase2b 前台残留清理收口 | `6e69a6e5` | `feature/v0.5.5` |
| 667 | 2026-06-01 | 关联 Browser Dock Phase 3 提案文档 | `80f3ada6`, `3ec81734` | `feature/v0.5.5` |
...
| 628 | 2026-05-29 | Phase2a 三证状态查询对账 | `6bfc0a21` | `feature/v0.5.4` |
...
| 341 | 2026-05-06 | 拆分线程列表路径兼容测试 | `c967865f` | `feature/v.0.4.14-2` |
| 340 | 2026-05-06 | 拆分消息视图行为测试 | `9bacb07e` | `feature/v.0.4.14-2` |
| 339 | 2026-05-06 | 拆分 app server events 输入路由测试 | `23f7b329` | `feature/v.0.4.14-2` |
...
| 331 | 2026-05-06 | 大文件治理首批 near-threshold 清理 | `b6a57e05` | `feature/v.0.4.14-2` |
| 330 | 2026-05-06 | 收敛 workflow 流程手册职责 | `5333184b` | `feature/v.0.4.14-2` |
| 329 | 2026-05-06 | 收敛规则入口并对齐注入链路 | `bc131f70` | `feature/v.0.4.14-2` |
...
| 6 | 2026-04-17 | 兼容 Claude plan 卡片标题变种 | `eb88587` | `feature/vvvv0.4.2-1` |
| 5 | 2026-04-17 | 补充 v0.4.2 changelog 发布说明 | `a85197c` | `feature/vvvv0.4.2-1` |
| 4 | 2026-04-17 | Claude 模式审批修复与 Trellis 记录规则补强 | `fd9272e`, `ba0b46d` | `feature/vvvv0.4.2-1` |
| 3 | 2026-04-17 | 强化 Trellis 提交后记录门禁并补齐 Claude rollout 提案 | `1e3d02c` | `feature/vvvv0.4.2-1` |
