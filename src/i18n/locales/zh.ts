const zh = {
  ...
  settings: {
    ...
    mcpPanel: {
      title: "MCP 服务器",
      description: "查看当前账号的全局 MCP 服务器与工具状态（不随项目切换）。",
    ...
    fontSizeLevel5: "大（120%）",
    fontSizeLevel6: "最大（140%）",
  ...
  chat: {
    ...
    contextDualViewCompacted: "上下文已压缩",
    ...
    contextDualViewAutoCompactionNote: "Codex 自动压缩背景信息",
