// browserAgent — Simplified Chinese UI strings
const browserAgent = {
  browserAgent: {
    dock: {
    ...
    composer: {
      ...
      selectedElement: "已选择网页元素",
      selectedElementCount: "已选择 {{count}} 个网页元素",
      selectedElementFacts: "选中网页元素事实",
      selectedElementMore: "另有 {{count}} 个元素",
      selectorHint: "选择器 {{selector}}",
