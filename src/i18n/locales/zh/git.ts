...
const git = {
  git: {
    ...
    historyCurrentBranch: "当前分支",
    historyToggleRepositoryBranches: "展开/收起 {{scope}}仓库 {{repository}} 的分支",
    historyRepositoryBranchesLoading: "正在加载分支...",
    historyRepositoryBranchesLoadFailed: "分支加载失败",
    historyRepositoryNoLocalBranches: "无本地分支",
    historyRepositoryNoRemoteBranches: "无远程分支",
    ...
    repositoryBatchUpdateAll: "更新全部",
    repositoryBatchCheckoutAll: "切换全部分支…",
    repositoryBatchSummary: "成功 {{success}}，失败 {{failed}}，跳过 {{skipped}}。",
    repositoryBatchFailedRepositories: "失败仓库：{{repositories}}",
    repositoryBatchLoadingBranches: "正在获取公共分支…",
    repositoryBatchCommonLocalBranches: "公共本地分支",
    repositoryBatchCommonRemoteBranches: "公共远程分支",
    repositoryBatchNoCommonBranches: "这些仓库没有公共分支。",
    repositoryBatchBranchesLoadFailed: "无法获取以下仓库的分支：",
