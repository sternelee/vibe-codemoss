...
const files = {
  files: {
    ...
    saved: "已保存",
    gitBlame: "Git Blame",
    gitBlameEnable: "显示 Git Blame",
    gitBlameDisable: "隐藏 Git Blame",
    gitBlameLoading: "正在加载 Blame...",
    gitBlameStale: "Blame 已过期",
    gitBlameError: "Blame 不可用",
    gitBlameUnavailable: "当前文件无法使用 Git Blame。",
    gitBlameMenu: "Git Blame 选项",
    ...
    gotoImplementations: "跳转到实现",
    findReferences: "查找引用",
    navigating: "跳转中...",
    searchingReferences: "正在查找引用...",
    navigationNoDefinition: "当前位置未找到定义",
    navigationNoImplementation: "当前位置未找到实现",
    navigationError: "导航请求失败",
    navigationDefinitionSymbolRequired: "请把光标放在类、方法、变量或类型名称上，再跳转到定义。",
    navigationReferencesSymbolRequired: "请把光标放在类、方法、变量或类型名称上，再查找引用。",
    navigationImplementationSymbolRequired: "请把光标放在类、接口或可被实现的方法上，再查找实现。",
    navigationUnsupportedLanguage: "当前文件语言暂不支持这项代码导航操作。",
    navigationDefinitionError: "跳转到定义失败，请重试。",
    navigationReferencesError: "查找引用失败，请重试。",
   ...
   navigationFallbackNotice: "语言服务当前不可用，已改用快速搜索。安装对应语言服务后重试可获得更准确结果；当前结果可能包含同名项。",
    navigationLanguageServerMissing: "未检测到语言服务",
    navigationInstallCommand: "建议安装命令",
    navigationOpenInstallGuide: "打开官方下载页",
    navigationCopyInstallCommand: "复制命令",
    navigationInstallCommandCopied: "已复制",
    navigationRetryAfterInstall: "安装完成，重新检测",
    navigationResults: "个结果",
    definitionCandidates: "定义候选",
    implementationCandidates: "实现候选",
    referenceResults: "引用结果",
    noReferencesFound: "未找到引用",
    openFind: "在文件中查找 (⌘/Ctrl+F)",
    tabContextMenu: "文件标签操作",
    fileContextMenu: "文件操作",
    clipboardActionFailedTitle: "剪贴板操作失败",
    clipboardActionFailed: "{{action}}失败：{{message}}",
    clipboardUnavailable: "当前无法访问剪贴板。",
    tabGitActions: "Git 操作",
    tabShowFileHistory: "显示文件历史",
