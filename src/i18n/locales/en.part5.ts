const enPart5 = {
  ...
  projectMap: {
    ...
    relationship: {
      ...
      metricRepair: " repair",
      snapshotLabel: "Scan Snapshot",
      snapshotRule: "This is an isolated relationship dashboard and will not auto-merge into the current Project Map graph, avoiding performance and visual noise.",
      ...
      neighborhoodTitle: "Selected file neighborhood",
      incoming: "incoming",
      outgoing: "outgoing",
