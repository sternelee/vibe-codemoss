const en = {
  ...
  settings: {
    ...
    mcpPanel: {
      title: "MCP Servers",
      description: "Inspect account-level global MCP servers and tool availability (not project-specific).",
    ...
    fontSizeLevel5: "Large (120%)",
    fontSizeLevel6: "Largest (140%)",
  ...
  chat: {
    ...
    contextDualViewCompacted: "Context compacted",
    ...
    contextDualViewAutoCompactionNote: "Codex automatically compacts background info",
