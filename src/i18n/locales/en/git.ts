...
const git = {
  git: {
    ...
    historyCurrentBranch: "current branch",
    historyToggleRepositoryBranches: "Toggle {{scope}} branches for {{repository}}",
    historyRepositoryBranchesLoading: "Loading branches...",
    historyRepositoryBranchesLoadFailed: "Failed to load branches",
    historyRepositoryNoLocalBranches: "No local branches",
    historyRepositoryNoRemoteBranches: "No remote branches",
