const enPart2 = {
  ...
  files: {
    ...
    fileCompare: {
      ...
      workspaceUnavailable: "Current workspace is unavailable for file compare.",
      tooManyFiles: "File compare supports up to {{limit}} files. {{count}} files are selected; reduce the selection.",
    ...
    unsavedChangesCloseDescription: "Your changes have not been saved and will be lost.",
    ...
    associateIntentCanvasTitle: "Link {{symbol}} as an Intent Canvas source anchor",
    associateIntentCanvasUnavailableTitle: "This line cannot link Canvas",
    associateIntentCanvasUnavailable: "Place the cursor on a class, method, or property declaration before linking Canvas",
  ...
  agentOrchestration: {
    ...
    manual: {
      ...
      description: "Manual tasks do not invent verified evidence. Add scope and acceptance before dispatch.",
      fieldTitle: "Title",
      fieldScope: "Scope",
    ...
    actions: {
      ...
      writeBackDisabled: "Provider write-back is a future action: it must go through a separate confirmation flow. OpenSpec, Trellis, spec-kit, and agent rule files are not modified here.",
    },
    queue: {
      taskLabel: "{{title}}, status {{status}}, provider {{provider}}, {{risks}} risk marker(s)",
    ...
    dispatch: {
      ...
      description: "Configure engine, workspace, thread strategy, and acceptance scope first. A TaskRun is created only after confirming dispatch.",
      engine: "Engine",
      model: "Model",
      ...
      sources: "Sources",
      disabled: "Execution is not wired yet: this only previews dispatch parameters and will not create a TaskRun.",
      cancel: "Cancel",
    ...
    review: {
      ...
      title: "Review Gate",
      description: "The linked run has completed. Review the result before accepting, requesting changes, or creating a follow-up task.",
      accept: "Accept result",
      requestChanges: "Request changes",
      createFollowUp: "Create follow-up",
      missingRunTitle: "Missing execution result; review is unavailable",
      missingRunDescription: "This task is marked for review, but it has no linked run or linked session. Dispatch it again before reviewing.",
      feedback: {
        accepted: "Result accepted. The task is complete.",
        changesRequested: "Changes requested. The task moved back to the work queue.",
    ...
    filters: {
      ...
      emptyDescription: "Adjust provider, status, engine, workspace, source kind, or risk filters to continue.",
    },
    reviewState: {
    ...
    detail: {
      ...
      selectionPreservedDescription: "The task status changed, but the detail pane stays on the node you just acted on.",
    },
  },
  ...
  taskCenter: {
    ...
    openedFromProjectMap: "Opened the linked Run from the Project Map work queue. This page shows the real TaskRun detail; if no conversation action appears, this Run is not linked to a real session yet.",
    trigger: "Trigger",
    updatedAt: "Updated",
