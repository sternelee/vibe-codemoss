...
describe("Markdown math rendering", () => {
  ...
  it("renders inline and display LaTeX formulas", async () => {
    const value = [
      "行内公式：$a^2 + b^2 = c^2$",
      "",
      "$$",
  ...
  it("normalizes codex-style parentheses delimiters for inline formulas", async () => {
    const value = [
  ...
  it("renders codex-style over-escaped delimiters mixed with dollar math", async () => {
    const value = [
  ...
  it("supports mixed single and double backslash inline delimiters in one sentence", async () => {
  ...
  it("renders prose that mixes $...$, $$...$$, \\(...\\), and \\[...\\]", async () => {
    const value = [
  ...
  it("renders codex list prose that embeds $$...$$ and \\[...\\] without katex errors", async () => {
    const value = [
  ...
  it("downgrades malformed $$...$$ prose blocks and keeps inner inline math renderable", async () => {
  ...
  it("extracts leading bare latex before cjk prose into display math", async () => {
  ...
  it("preserves function-style parentheses inside valid inline formulas", async () => {
  ...
  it("promotes standalone bare latex lines inside prose to display math", async () => {
    const value = [
  ...
  it("keeps standalone single-dollar formulas renderable without wrapping them twice", async () => {
    const value = [
      "后验概率满足",
  ...
  it("does not parse inline formula when closing dollar is escaped", async () => {
  ...
  it("parses inline formula when closing dollar has an even backslash prefix", async () => {
  ...
  it("keeps indented formulas renderable inside ordered lists", async () => {
    const value = [
      "1. 贝叶斯公式",
      "   P(\\theta\\mid D)=\\frac{P(D\\mid \\theta)P(\\theta)}{P(D)}",
      "",
  ...
  it("renders dedicated latex fenced blocks with formula preview", async () => {
    const value = [
      "```latex",
      "% 1) 二次方程求根公式",
