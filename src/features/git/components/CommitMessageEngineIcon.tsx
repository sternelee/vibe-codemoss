...
export function CommitMessageEngineIcon({
  ...
  if (engine === "claude") {
    return (
      <svg viewBox="0 0 24 24" className={className} style={iconStyle} aria-hidden>
        <path
  ...
  if (engine === "opencode") {
    return (
      <svg viewBox="0 0 24 24" fill="none" className={className} style={iconStyle} aria-hidden>
        <rect x="3.2" y="4.2" width="17.6" height="15.6" rx="2.3" stroke="#3B82F6" strokeWidth="1.6" />
